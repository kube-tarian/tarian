...
require (
	...
	github.com/intelops/tarian-detector v0.0.0-20240409174539-f64cc9996cb4
...
replace github.com/intelops/tarian-detector => github.com/andylibrian/tarian-detector v0.0.0-20240411210231-ed2f56c7ffc9
