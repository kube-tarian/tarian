...
var file_tarianpb_types_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_tarianpb_types_proto_goTypes = []interface{}{
	...
	(*Label)(nil),                 // 6: tarianpb.types.Label
	(*Pod)(nil),                   // 7: tarianpb.types.Pod
	(*Target)(nil),                // 8: tarianpb.types.Target
...
var file_tarianpb_types_proto_depIdxs = []int32{
	...
	6,  // 4: tarianpb.types.Pod.labels:type_name -> tarianpb.types.Label
	7,  // 5: tarianpb.types.Target.pod:type_name -> tarianpb.types.Pod
	5,  // 6: tarianpb.types.Target.violatingProcesses:type_name -> tarianpb.types.Process
	10, // 7: tarianpb.types.Event.serverTimestamp:type_name -> google.protobuf.Timestamp
	10, // 8: tarianpb.types.Event.clientTimestamp:type_name -> google.protobuf.Timestamp
	10, // 9: tarianpb.types.Event.alertSentAt:type_name -> google.protobuf.Timestamp
	8,  // 10: tarianpb.types.Event.targets:type_name -> tarianpb.types.Target
